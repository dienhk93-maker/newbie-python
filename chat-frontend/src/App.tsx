      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white/[0.03] border-r border-white/[0.07] flex-shrink-0">
        ...
        <div className="p-3">
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm text-gray-400 hover:text-white hover:bg-white/[0.07] transition-all duration-200 group"
          >
            <svg className="w-4 h-4 group-hover:text-indigo-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
